 ...
 * Explanation 1:
 * 
 * Distance of node having value 1 from root node = 1 Distance of node having
 * value 4 from root node = 2 (max) Distance of node having value 3 from root
 * node = 2 (max) Explanation 2:
 * 
 * Distance of node having value 1 from root node = 1 Distance of node having
 * value 4 from root node = 2 Distance of node having value 3 from root node = 2
...
public class TreeHeight {
	...
	public int solve(TreeNode node) {
		...
		if (node == null)
			...
			int lDepth = solve(node.left);
			int rDepth = solve(node.right);
	...
	public static void main(String[] args) {
		...
		System.out.println("Height of tree is : " + new TreeHeight().solve(tree));
	}
