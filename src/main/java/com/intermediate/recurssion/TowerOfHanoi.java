...
public class TowerOfHanoi {
	...
	void toh(int N, int src, int dest, int temp, ArrayList<ArrayList<Integer>> result) {
		if (N == 0)
			return;
	...
	public static void main(String[] args) {
		...
		ArrayList<ArrayList<Integer>> result = toh.towerOfHanoi(3);
