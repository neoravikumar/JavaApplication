...
public int solve(ArrayList<Integer> A) {
        ...
        int temp = A.get(1)-A.get(0);
        for(int i=1;i<N;i++) {
        	int temp2 = A.get(i)-A.get(i-1);
        	if(temp!=temp2) {
        		return 0;
        	}
        }
