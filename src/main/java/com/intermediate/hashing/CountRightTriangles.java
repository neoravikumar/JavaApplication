...
public class CountRightTriangles {
	...
	public int solve(ArrayList<Integer> A, ArrayList<Integer> B) {
	    ...
	    for(int i=0;i<A.size();i++)
	    {
	        cnt += (map1.get(A.get(i))-1)*(map2.get(B.get(i))-1);
	        cnt%=1000000007;
	    }
	    return (int) cnt;
	...
	public static void main(String[] args) {
		...
		int result = countRightTriangles.solve(new ArrayList<Integer>(Arrays.asList(36, 11, 33)), new ArrayList<Integer>(Arrays.asList(37, 32, 4)));
